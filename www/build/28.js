...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__info_produk__ = __webpack_require__(324);
...
var InfoProdukPageModule = /** @class */ (function () {
    ...
    InfoProdukPageModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["I" /* NgModule */])({
            ...
            imports: [
                __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["e" /* IonicPageModule */].forChild(__WEBPACK_IMPORTED_MODULE_2__info_produk__["a" /* InfoProdukPage */]),
            ],
        })
...
var InfoProdukPage = /** @class */ (function () {
    ...
    InfoProdukPage = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["m" /* Component */])({
            selector: 'page-info-produk',template:/*ion-inline-start:"E:\KKI II\ionic-petro3\src\pages\info-produk\info-produk.html"*/'<ion-header class="headerHome">\n\n  <ion-navbar no-border-bottom color="header">\n\n    <button ion-button menuToggle>\n\n      <ion-icon name="menu"></ion-icon>\n\n    </button>\n\n    <ion-title>Info Produk</ion-title>\n\n  </ion-navbar>\n\n</ion-header>\n\n\n\n\n\n<ion-content padding="true" class="has-header">\n\n	<ion-slides autoplay="5000" loop="true" speed="3000" style="width:100%;height:200px;" class="slideImage">\n\n      <ion-slide *ngFor="let slide of slideData">\n\n        <img src="{{slide.image}}" />\n\n      </ion-slide>\n\n  </ion-slides>\n\n\n\n  <ul>\n\n    <li><a ui-sref="menu.pupuk()" id="infoProduk-button52" class="btn paper paper-raise-flatten">Pupuk</a></li>\n\n    <li><a ui-sref="menu.nonPupuk()" id="infoProduk-button53" class="btn paper paper-raise-flatten">Non Pupuk</a></li>\n\n    <li><a ui-sref="menu.brosur()" id="infoProduk-button54" class="btn paper paper-raise-flatten">Brosur</a></li>\n\n    <li><a ui-sref="menu.dosisPemupukan()" id="infoProduk-button55" class="btn paper paper-raise-flatten">Dosis Pemupukan</a></li>\n\n    <li><a ui-sref="menu.testimoniProduk()" id="infoProduk-button56" class="btn paper paper-raise-flatten">Testimoni Produk</a></li>\n\n  </ul>\n\n\n\n</ion-content>\n\n'/*ion-inline-end:"E:\KKI II\ionic-petro3\src\pages\info-produk\info-produk.html"*/,
        }),
